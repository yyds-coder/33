...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default= '/hy-tmp/wzry/wzry_model.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/hy-tmp/wzry/wzry_parameter.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=192, help='train, val image size (pixels)')
